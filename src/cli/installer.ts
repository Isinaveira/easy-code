import { intro, outro, spinner, note, select, isCancel, text, multiselect } from '@clack/prompts'; // ◄ Añadidos text y multiselect
...
async function configureNode(): Promise<void> {
  ...
  const selectedAgents = await multiselect({
    message: 'Selecciona los agentes que se ejecutarán en este nodo:',
    options: [
